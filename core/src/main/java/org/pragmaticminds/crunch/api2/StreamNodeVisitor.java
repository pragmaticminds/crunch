...
/**
 * Visitor pattern for {@link StreamNode}.
 */
public interface StreamNodeVisitor<T> {

  <IN> T visit(Root<IN> root);

  <IN> T visit(Filter<IN> filter);

  <KEY, IN> T visit(GroupBy<KEY, IN> groupBy);
